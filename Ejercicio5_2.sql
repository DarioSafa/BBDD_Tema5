...
SELECT EMPLEADOS.NOMBRE, EMPLEADOS.APELLIDOS, DEPARTAMENTO.NOMBRE FROM EMPLEADOS,DEPARTAMENTO WHERE EMPLEADOS.CLAVE_DEPTO = DEPARTAMENTO.CLAVE_DEPTO AND EMPLEADOS.NOMBRE LIKE '%a';
...
SELECT EMPLEADOS.NOMBRE, EMPLEADOS.CLAVE_DEPTO FROM EMPLEADOS WHERE EMPLEADOS.CLAVE_DEPTO = 4;

--G. Obtener el nombre y apellidos de los empleados cuyo apellido comienza con ‘H’.

SELECT EMPLEADOS.NOMBRE,EMPLEADOS.APELLIDOS FROM EMPLEADOS WHERE EMPLEADOS.APELLIDOS LIKE 'H%';
...
SELECT EMPLEADOS.CLAVE_EMPLEADO,EMPLEADOS.NOMBRE,EMPLEADOS.APELLIDOS FROM EMPLEADOS,DEPARTAMENTO WHERE EMPLEADOS.CLAVE_DEPTO = DEPARTAMENTO.CLAVE_DEPTO AND DEPARTAMENTO.NOMBRE = 'Contabilidad';
...
SELECT EMPLEADOS.NOMBRE AS "NOMBRE EMPLEADO",EMPLEADOS.APELLIDOS,DEPARTAMENTO.NOMBRE AS "NOMBRE DEPARTAMENTO" FROM EMPLEADOS,DEPARTAMENTO;
